...
OFFPOLICY_COLLECTOR_TIMING_ORDER = {
    ...
    "env_step_ms": 5,
    "env_step_total_ms": 6,
    "env_inner_step_total_ms": 7,
    "env_apply_action_ms": 8,
    "env_step_core_ms": 9,
    "env_update_state_ms": 10,
    "env_reset_done_ms": 11,
    "postprocess_ms": 12,
    "rollout_finalize_ms": 13,
    "rollout_total_ms": 14,
    "replay_ms": 15,
    "sync_coordination_ms": 16,
}

OFFPOLICY_COLLECTOR_TIMING_LABELS = {
    "weight_sync_ms": "Weight Sync",
    "ring_wait_ms": "Ring Wait",
    "action_select_ms": "Action Select",
    "mlp_infer_ms": "MLP Infer",
    "ipc_write_ms": "IPC Write",
    "env_step_ms": "Env Step",
    "env_step_total_ms": "Env Step Total",
    "env_inner_step_total_ms": "Env Inner Total",
    "env_apply_action_ms": "Env Apply Action",
    "env_step_core_ms": "Env Core",
    "env_update_state_ms": "Env Update State",
    "env_reset_done_ms": "Env Reset Done",
    "postprocess_ms": "Postprocess",
    "rollout_finalize_ms": "Rollout Finalize",
    "rollout_total_ms": "Rollout Total",
    "replay_ms": "Replay",
